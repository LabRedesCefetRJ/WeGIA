...
// Segundo statement
$sql2 = "SELECT p.nome, p.cpf, p.email, p.data_nascimento, p.cep, p.logradouro, p.numero_endereco, p.complemento, p.bairro, p.estado, p.cidade, p.telefone, st.tipo, ss.status, s.data_referencia, s.valor_periodo
FROM pessoa as p
