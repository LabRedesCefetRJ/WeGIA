...
$id_socio = trim(filter_input(INPUT_GET, 'socio', FILTER_SANITIZE_NUMBER_INT));

if (!$id_socio || $id_socio < 1) {
    $caminho = '../../home.php';
    $mensagem = "msg_c=Sócio inválido";
    header("Location: $caminho?$mensagem");
    exit();
}
?>
<!DOCTYPE html>
