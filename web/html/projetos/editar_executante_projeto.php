...
$membro = $projetoDAO->buscarMembroEquipe($id);

if (!$membro) {
  header('Location: informacao_projeto.php?msg=Membro não encontrado!');
  exit();
}

$id_projeto = $membro['id_projeto'];
...
<body>
        ...
        <div class="col-md-12">
          <div class="tabs">
            <ul class="nav nav-tabs tabs-primary">
              <li class="active"><a href="#dados" data-toggle="tab">Dados do Executante</a></li>
            </ul>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <form class="form-horizontal" role="form">
                      <h4 class="mb-xlg">Dados do Executante no Projeto</h4>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control campo-readonly"
                            value="<?= htmlspecialchars(trim($membro['nome'] . ' ' . $membro['sobrenome'])) ?>"
                            readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control campo-readonly"
                            value="<?= htmlspecialchars($membro['cpf'] ?? '--') ?>"
                            readonly>
                        </div>
                      </div>
  ...
  <script src="../../Functions/projetos_executante_editar.js"></script>
