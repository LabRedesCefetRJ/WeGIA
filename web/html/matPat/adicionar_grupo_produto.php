...
<head>
	...
	<title>Adicionar Grupo de Produto</title>
				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Cadastro Grupo de Produto</span></li>
						</ol>
					...
					<div class="col-md-8 col-lg-8">
						<div class="tabs">
							<ul class="nav nav-tabs tabs-primary">
								<li class="active">
									<a href="#overview" data-toggle="tab">Adicionar Grupo de Produto</a>
								</li>
							</ul>
							<div class="tab-content">
								<div id="overview" class="tab-pane active">
									<fieldset>
										<?php if (isset($_SESSION['erro_grupo_produto'])): ?>
    										...
    										<?php unset($_SESSION['erro_grupo_produto']); ?>
