...
class SaudePetDAO
{
    ...
    public function listarTodos()
    {
        ...
        while ($linha = $pd->fetch(PDO::FETCH_ASSOC)) {
            $pets[$x] = array('id_ficha_medica' => htmlspecialchars($linha['id_ficha_medica']), 'id_pet' => htmlspecialchars($linha['id_pet']), 'nome' => htmlspecialchars($linha['nome']), 'raca' => htmlspecialchars($linha['raca']), 'cor' => htmlspecialchars($linha['cor']), 'necessidades_especiais' => htmlspecialchars($linha['necessidades_especiais']));
            $x++;
        }
