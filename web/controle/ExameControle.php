<?php
require_once dirname(__FILE__, 2) . DIRECTORY_SEPARATOR . 'dao' . DIRECTORY_SEPARATOR . 'ExameDAO.php';
...
class ExameControle
{
    ...
    public function listarExamesPorId()
    {
        ...
        try {
            ...
            $exameDAO = new ExameDAO;
            $resposta = $exameDAO->listarExamesPorId($idFichamedica);
    ...
    public function inserirExame()
    {
        ...
        switch($arquivo['erro']){
            case UPLOAD_ERR_INI_SIZE:
                $menssagem = "O arquivo selecionado excede o tamanho máximo permitido. Por favor, escolha um arquivo menor e tente novamente.";

            case UPLOAD_ERR_FORM_SIZE:
                $menssagem = "O arquivo selecionado excede o tamanho máximo permitido. Por favor, escolha um arquivo menor e tente novamente.";
        
            default:
                $menssagem = "Erro no upload do arquivo.";
        }
            http_response_code(400);
            echo json_encode(["erro" => $menssagem . " Código: " . $arquivo['error']]);
            exit;
        }
