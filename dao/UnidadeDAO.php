<?php
require_once ROOT . '/classes/Unidade.php';
...
class UnidadeDAO
{
    ...
    public function listarTodos()
    {
        ...
        try {
            ...
            $x = 0;
            while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                $unidades[$x] = array('id_unidade' => htmlspecialchars($linha['id_unidade']), 'descricao_unidade' => htmlspecialchars($linha['descricao_unidade']));
                $x++;
            }
        } catch (PDOException $e) {
