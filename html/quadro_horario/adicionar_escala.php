				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Adicionar Escala</span></li>
						</ol>
					...
					<div class="col-md-8 col-lg-8">
						...
						<div class="tabs">
							<ul class="nav nav-tabs tabs-primary">
								<li class="active">
									<a href="#overview" data-toggle="tab">Inserir Escala
									</a>
								</li>
							</ul>
										...
										<form method="post" id="formulario" action="../../controle/control.php">
											...
											?>
												<div class="form-group"><br>
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="escala" id="descricao_escala" required>
													</div>
												</div><br />
