...
include_once ROOT . '/dao/ProdutoDAO.php';
	...
	if(!isset($_SESSION['unidade'])) {
		extract($_REQUEST);
		header('Location: ' . WWW . 'controle/control.php?metodo=listarTodos&nomeClasse=UnidadeControle&nextPage=../html/matPat/alterar_produto.php?id_produto='.$id_produto);
	}
	if(!isset($_SESSION['categoria'])){
		extract($_REQUEST);
		header('Location: ' . WWW . 'controle/control.php?metodo=listarTodos&nomeClasse=CategoriaControle&nextPage=../html/matPat/alterar_produto.php?id_produto='.$id_produto);
	}
